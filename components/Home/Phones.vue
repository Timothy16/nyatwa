      ...
      <!-- style="background-color: #F4F4FF;" -->
          <div class="container move-up mockup-bg">
              ...
              <div class="section-company display-c-l">
                  <nuxt-img src="/images/techcrunch.svg" class="img-fluid r-m-l" alt="" srcset="" /> 
                  <nuxt-img src="/images/business.svg" class="img-fluid r-m-l" alt="" srcset="" /> 
                  <nuxt-img src="/images/techpoint.svg" class="img-fluid r-m-l" alt="" srcset="" /> 
                  <nuxt-img src="/images/techcabal.svg" class="img-fluid r-m-l" alt="" srcset="" />
              </div>
          </div>
      </div>
  </template>
