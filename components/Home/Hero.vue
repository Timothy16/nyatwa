...
<div style="background-color: #fff;">
  ...
  <div class="container hero-down">
    ...
    <div class="d-flex justify-content-center mt-5 btn-hero-t">
        <div data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn-download-hero animate__animated animate__fadeInUp animate__slow"><span class="pic-up"><img src="/nyatwa/images/DeviceMobileCamera.svg" class="img-fluid" alt="" srcset="" /></span>&nbsp; Download the app</div>
    </div>
    <div class="money-s-1 animate__animated animate__backInUp animate__slow">
            <img src="/nyatwa/images/hero-money-1.svg" class="img-fluid img-m-v" alt="" srcset="" />
    </div>
    <div class="money-s-2 animate__animated animate__backInUp animate__slow">
        <img src="/nyatwa/images/hero-money-2.svg" class="img-fluid img-m-v" alt="" srcset="" />
    </div>
  </div>
